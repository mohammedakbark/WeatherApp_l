...
const blendWhite = Colors.white70;
const humidityWindAndDescriptionColor = Color.fromARGB(255, 119, 152, 175);
const cityAndTemperatureColor = Color.fromARGB(255, 36, 91, 131);
const defaultAmber = Colors.amber;
